...
// VulkanResult<Res<Self>> {         let ctx = &resources.ctx;

//         let color_blend = vk::PipelineColorBlendAttachmentState::default()
//             .color_write_mask(vk::ColorComponentFlags::R |
// vk::ColorComponentFlags::G | vk::ColorComponentFlags::B |
// vk::ColorComponentFlags::A)             .blend_enable(false);
...
// vk::ShaderStageFlags::FRAGMENT)])             .build()?;
...
// .vertex_input_info(vertex_input_info)         //     .build()?;
