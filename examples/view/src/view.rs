...
use aluminium::{
    ...
    RenderTarget, Res, Resolution, Scissor, ShaderType, StorageBuffer, StorageBufferDesc, StoreOp,
    Texture, TextureDesc, TextureFormat, TransientTexture, VertexInput, Viewport, WorldRenderer,
};
        ...
        match event {
            ...
            WindowEvent::RedrawRequested => {
                ...
                let _ = self.world.draw_frame(move |frame| {
                    ...
                    //             let _ = builder.write_color(backbuffer,
                    // LoadOp::Clear, StoreOp::DontCare);
                    //             let _ = builder.write_depth(gbuffer.depth,
                    // LoadOp::Clear, StoreOp::DontCare);
